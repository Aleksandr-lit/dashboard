(() => {
    ...
    const menuBtn = document.querySelectorAll(".menu__title");
    ...
    document.addEventListener("click", (e => {
        ...
        const withinBoundariesBtn = e.composedPath().includes(btn);
        if (!withinBoundariesMenu && !withinBoundariesBtn) document.documentElement.classList.remove("menu-open");
    }));
